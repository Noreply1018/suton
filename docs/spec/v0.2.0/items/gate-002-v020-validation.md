...
- 占位阻塞契约：
  - 当前仓库尚未实现的 `make verify-visual`、除 `v020-project-document-api`、`v020-document-detail-fields`、`v020-document-reprocess-api`、`v020-document-scope-disabled`、`v020-project-name-limits`、`v020-question-scope-errors`、`v020-question-history-api`、`v020-question-detail-api`、`v020-question-research-scope-errors` 和 `v020-stale-source` 以外的 `make verify-api-contract CHECK=v020-*`、除 `v020-schema`、`v020-confidence-levels`、`v020-confidence-level-fields`、`v020-project-name-migration`、`v020-project-hard-delete`、`v020-document-hard-delete`、`v020-delete-consistency`、`v020-delete-trash-cleanup`、`v020-document-reprocess-no-duplicates`、`v020-document-health-fields`、`v020-document-health`、`v020-processing-failure-fields`、`v020-source-detail-fields` 和 `v020-question-research-consistency` 以外的 `make verify-db CHECK=v020-*`、`make verify-e2e SCENARIO=v020-*` 不得被空 target、只打印文本、只检查文件存在、跳过真实服务或 dry-run 替代。
